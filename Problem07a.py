...
def step_input(intcode, pointer, modes, world):  # opcode 3
    ...
    new_world = world       # FIRST DRAFT: leaving the world unchanged
    return (new_list, pointer+2, new_world)
...
def run(intcode, world=[]):
    pointer = 0
    while pointer > -1:
        (intcode, pointer, world) = step(intcode, pointer, world)
    return (intcode, world)
